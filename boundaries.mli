(** Boundaries (persistent/ephemeral) / axis-aligned bounding-box of
    statically typed dimension*)
...
val classify_value : eps:float -> (_,'n N.succ) t -> (_,'n N.succ) Vector.t -> cls
